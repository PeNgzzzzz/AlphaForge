...
- Shared validation core: repeated positive-integer, finite-float, runtime float-bound, non-empty string, and required-column checks delegate to `alphaforge.common.validation` while package wrappers preserve their existing exception types.
