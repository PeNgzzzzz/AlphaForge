...
- Shared validation core: repeated positive-integer, finite-float, and runtime float-bound checks delegate to `alphaforge.common.validation` while package wrappers preserve their existing exception types.
